...
/* The matching uses path-to-regexp, which is the matching engine used by express as well, so the same matching rules apply. For detailed rules, see https://github.com/pillarjs/path-to-regexp */
